import icons from 'url:../../img/icons.svg'; //Phải import vì parcel hiểu nó là tệp lệnh chứ không phải ảnh
import fracty from 'fracty' //npm library chuyển từ số hữu tỉ sang phân số (vd: 0.5 --> 1/2)
